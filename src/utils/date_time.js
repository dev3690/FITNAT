...
export const getWeeklyEndDates = (startDate, endDate, currentWeek) => {
    ...
    console.log("DIFF",result,currentWeek,new Date().getDate())
    let res = (result[currentWeek - 1].getDate() - 2) == new Date().getDate()
